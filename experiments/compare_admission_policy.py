...
(output/output-{scenario}/models/). Does NOT retrain anything -- if
...
Usage
-----
    python experiments/compare_admission_policy.py                        # all 3 scenarios, 20 seeds, 300 steps
    python experiments/compare_admission_policy.py --seeds 1 --steps 60    # quick smoke test
    python experiments/compare_admission_policy.py --scenarios urban_medium --seeds 5
...
# Allow `python experiments/compare_admission_policy.py` to find the
