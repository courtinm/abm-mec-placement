...
class SmallScenario:
    ...
    def setup_healthcare(self):
        ...
        healthcare.add_daily_count(Pfizer, 100)
...
Plotter.draw_bar_graph(analytics.contact_count.daily_contact_count, plot=ax1, title="Contacts per day")
# Plotter.draw_bar_graph(store.contact_count.daily_unique_contact_count, plot=ax2, title="Unique contacts per day")
Plotter.draw_bar_graph(analytics.vaccination_count.vaccinated, plot=ax2, title="Vaccinated per day")
Plotter.draw_bar_graph(analytics.traveled_distance.traveled_distance, plot=ax3, title="Covered ground per day")
Plotter.draw_active_infected(analytics.state_changes.state_changes, plot=ax4, plot_days=True, title="Infected per day")
